  ...
  routes: [
    ...
    },
    {
      ...
      children: [
        ...
        {
          path: "roadmap-train",
          component: () => import("@/views/roadmap/roadmap-train/RoadMapTrainMain.vue"),
          children: [
            {
              path: "roadmap-train-first",
              name: "roadmap-train-first",
              component: () => import("@/views/roadmap/roadmap-train/days/RoadMapTrainFirst.vue"),
              props: true,
            },
          ],
        },
